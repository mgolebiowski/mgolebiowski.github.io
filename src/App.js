    ...
    <div className="app-wrapper">
      <div className="container">
        <div className="row">
          ...
          <h1>Hi, I'm Michał</h1>
          <p>I am Fullstack JavaScript developer with three years of experience with Javascript, Vue.js and React.</p>
        </div>
      ...
      <footer>
        <a href="http://github.com/mgolebiowski">
        ...
        <a href="http://www.linkedin.com/in/michal-golebiowski">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
